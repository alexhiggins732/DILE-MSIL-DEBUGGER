...
{
	public class ArgumentValueRefresher : BaseValueRefresher
	{
		...
		public ArgumentValueRefresher(string name, FrameRefresher frameRefresher, uint index)
			: base(name)
		{
		...
		public override ValueWrapper GetRefreshedValue()
		{
			...
			result = frame.GetArgument(index);
